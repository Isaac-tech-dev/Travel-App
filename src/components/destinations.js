...
const DestinationCard = ({ item, navigation }) => {
  ...
  return (
    ...
    >
      ...
      />
      <TouchableOpacity onPress={()=> setIsFavourite(!isFavourite)} style={{backgroundColor: 'rgba(255,255,255,0.4)'}} className="absolute top-1 right-3 rounded-full p-3">
      ...
      <Text className="text-white" style={{fontSize: wp(2.2)}}>{item.shortDescription}</Text>
    </TouchableOpacity>
  );
};
